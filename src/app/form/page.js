            ...
            <div className="row">
                ...
                <form>
                    ...
                    <div className="form-outline mb-4">
                        <Field class="form-control" type="text" name="title"/>
                        <label class="form-label" htmlFor="title">Product Name</label>
                    ...
                    <div className="form-outline mb-4">
                        ...
                        <label class="form-label" htmlFor="price">Product Price</label>
                    ...
                    <div className="form-outline mb-4">
                        ...
                        <label class="form-label" htmlFor="categoryId">Category</label>
